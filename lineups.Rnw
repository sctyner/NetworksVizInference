...
\begin{table}[h]
\caption{\label{tab:models}Parameters and estimates of models $M_1$ and $M_2$.}
\centering
\scalebox{0.8}{
\begin{tabular}{lccrr}
Effect name & Symbol & Corresponding Statistic & $M_1$ Estimate & $M_2$ Estimate\\
\hline
\hline
