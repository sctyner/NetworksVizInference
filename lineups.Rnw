...
\hh{Could you crop the white space from the lineup before saving it? - maybe this blog post helps: {http://robjhyndman.com/hyndsight/crop-r-figures/}}

\hh{Please add frames around the panels - it helps with separating the graphs from one another}
