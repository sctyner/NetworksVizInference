...
write.csv(simttbFitsSenate, "simttbModelFitsSenate100.csv")
simttbFitsSenate <- get_effects_dist(dat = senateSiena, struct = Senstt_b, N = 100)
write.csv(simttbFitsSenate, "simttbModelFitsSenate200.csv")
simttbFitsSenate <- get_effects_dist(dat = senateSiena, struct = Senstt_b, N = 100)
write.csv(simttbFitsSenate, "simttbModelFitsSenate300.csv")
simttbFitsSenate <- get_effects_dist(dat = senateSiena, struct = Senstt_b, N = 100)
write.csv(simttbFitsSenate, "simttbModelFitsSenate400.csv")
simttbFitsSenate <- get_effects_dist(dat = senateSiena, struct = Senstt_b, N = 100)
write.csv(simttbFitsSenate, "simttbModelFitsSenate500.csv")
simttbFitsSenate <- get_effects_dist(dat = senateSiena, struct = Senstt_b, N = 100)
write.csv(simttbFitsSenate, "simttbModelFitsSenate600.csv")
simttbFitsSenate <- get_effects_dist(dat = senateSiena, struct = Senstt_b, N = 100)
write.csv(simttbFitsSenate, "simttbModelFitsSenate700.csv")
simttbFitsSenate <- get_effects_dist(dat = senateSiena, struct = Senstt_b, N = 100)
write.csv(simttbFitsSenate, "simttbModelFitsSenate800.csv")
simttbFitsSenate <- get_effects_dist(dat = senateSiena, struct = Senstt_b, N = 100)
write.csv(simttbFitsSenate, "simttbModelFitsSenate900.csv")
simttbFitsSenate <- get_effects_dist(dat = senateSiena, struct = Senstt_b, N = 100)
write.csv(simttbFitsSenate, "simttbModelFitsSenate1000.csv")
